...
var _ = Describe("ManagedApp Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind ManagedApp")
			err := k8sClient.Get(ctx, typeNamespacedName, managedapp)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance ManagedApp")
